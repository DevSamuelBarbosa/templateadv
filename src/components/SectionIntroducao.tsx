...
export default function SectionIntroducao() {
	return (
		<section className="container px-8 md:px-0 py-12 md:py-0 mx-auto flex justify-center items-center md:-mt-12 md:pb-20">
			<div className="w-full xl:w-10/12 flex flex-col md:flex-row justify-center items-center gap-6 xl:gap-10">
				<div className="bg-quinary border-t-4 border-primary rounded px-4 lg:px-6 py-8 sm:py-4 flex flex-col gap-3 justify-center align-center h-full md:h-56 lg:h-60">
