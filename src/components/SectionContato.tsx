		...
		<section id="contato" className="container mx-auto flex justify-center items-center py-12 px-8 sm:py-20 sm:px-0">
			<div className="w-full xl:w-10/12 bg-quinary text-white p-6 rounded-md flex items-center justify-between gap-16">
				<div className="flex flex-col gap-6">
					...
					<Link href="//web.whatsapp.com/send?phone=5554993397936" target="_blank" className="hidden md:block w-fit px-6 py-3 bg-primary rounded-md text-white font-medium text-left text-base leading-relaxed hover:bg-primaryDark transition duration-300">
						<FontAwesomeIcon icon={faWhatsapp} />&nbsp;&nbsp;(54) 99339-7936
					</Link>

					<Link href="//api.whatsapp.com/send?phone=5554993397936" target="_blank" className="block md:hidden w-full px-6 py-3 bg-primary rounded-md text-white font-medium text-center text-base leading-relaxed hover:bg-primaryDark transition duration-300">
						<FontAwesomeIcon icon={faWhatsapp} />&nbsp;&nbsp;(54) 99339-7936
					</Link>
				</div>
			</div>
