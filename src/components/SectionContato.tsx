		...
		<section id="contato" className="container mx-auto flex justify-center items-center py-12 px-8 sm:py-20 sm:px-0">
			<div className="w-full xl:w-10/12 bg-quinary text-white p-6 rounded-md flex items-center justify-between gap-16">
				<div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-rpw gap-4 justify-start items-center">
                        ...
                        <Link href="https://mailto:samuelbarbosa170319@gmail.com" className="block md:hidden w-full px-6 py-3 bg-secondary rounded-md text-white font-medium text-center text-base leading-relaxed hover:bg-secondaryDark transition duration-300">
							<FontAwesomeIcon icon={faEnvelope} />&nbsp;&nbsp;samuelbarbosa170319@gmail.com
						</Link>
                    </div>
				</div>
